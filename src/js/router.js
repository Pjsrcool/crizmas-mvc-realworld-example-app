...
export default new Router({
  ...
  routes: [{
    ...
    children: [Router.fallbackRoute({
      to: '/'
    }), {
      resolve: () => resolveWith(import(
      /* webpackChunkName: 'home' */
      './pages/home/home'), import(
      /* webpackChunkName: 'home' */
      ...
      './pages/register/register'), import(
      /* webpackChunkName: 'register' */
      ...
      './pages/settings/settings'), import(
      /* webpackChunkName: 'settings' */
      ...
      resolve: () => Promise.all([import(
      /* webpackChunkName: 'profile' */
      './pages/profile/profile'), import(
      /* webpackChunkName: 'profile' */
      './pages/profile/profile-controller'), import(
      /* webpackChunkName: 'articles' */
      './pages/profile/articles/articles'), import(
      /* webpackChunkName: 'articles' */
      './pages/profile/articles/articles-controller')]).then(([{
        default: Profile
      }, {
      ...
      './pages/editor/editor'), import(
      /* webpackChunkName: 'editor' */
      './pages/editor/editor-controller')]).then(([{
        default: Editor
      }, {
        default: EditorRouteController
      }]) => ({
        children: [{
          component: Editor,
