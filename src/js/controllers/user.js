...
export const getUsernameValidator = () => validate(({
  input
}) => User.validateUsername(input.getValue()));
export const getPasswordValidator = () => validate(({
  input
}) => User.validatePassword(input.getValue()));
