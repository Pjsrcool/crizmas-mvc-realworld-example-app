...
export const getGlobalFeed = ({
  ...
  return get('articles', {
    offset,
    limit
  }).then(toJson).then(handleArticlesResult);
};
export const getOwnFeed = ({
  offset,
  limit
}) => {
  return get('articles/feed', {
    offset,
    limit
  }).then(toJson).then(handleArticlesResult);
};
...
export const getArticle = ({
  ...
  return get(`articles/${encodeURIComponent(slug)}`).then(toJson).then(({
    article
  }) => {
...
export const getArticleComments = ({
  ...
  return get(`articles/${encodeURIComponent(slug)}/comments`).then(toJson).then(({
    comments
  }) => {
